...
insert into Product_Attributes (attributes_key, product, attributes) values ('connector', 1, 'socket');
insert into Product_Attributes (attributes_key, product, attributes) values ('connector', 3, 'plug');